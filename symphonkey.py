...
When main() is run, keyboard events will be hooked to a function 
that will pick a random Hz in the range of NOTE_RANGE and play it for 
NOTE_LENGTH seconds. The length of time set for playing notes will 
influence howfast one can type without experiencing notes being 
